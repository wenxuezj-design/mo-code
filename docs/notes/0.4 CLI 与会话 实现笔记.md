...
```mermaid
flowchart TD
    LEGEND_NOW["绿色：当前预期实现范围"] ~~~ LEGEND_LATER["蓝色：后续预期实现"]
    ...
    classDef current fill:#dcfce7,stroke:#16a34a,color:#14532d,stroke-width:2px;
    classDef future fill:#dbeafe,stroke:#2563eb,color:#1e3a8a,stroke-width:2px;

    class LEGEND_NOW,START,SESSION,AGENT,MODE,INPUT,CHAT,COMPLETE,MESSAGES,SAVE,FILE,WARN,AFTER_SAVE,END current;
    class LEGEND_LATER,FUTURE,RESUME,CONTINUE,RELIABILITY,MANAGE,JSONL,COMPACT future;
```
